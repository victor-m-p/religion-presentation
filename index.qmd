...
## $J_{ij}$ and $h_i$ vs. surface-level features {.smaller} 
![](DAG/params-match-1.svg){ width=90% }
...
## $J_{ij}$ and $h_i$ vs. surface-level features {.smaller} 
![](DAG/params-match-2.svg){ width=90% }
...
## $J_{ij}$ and $h_i$ vs. surface-level features {.smaller} 
![](DAG/params-nomatch-1.svg){ width=90% }
...
![](DAG/norenzayan3.svg){ width=40% fig-align='center' } 
...
![](rank_vs_normp.svg){ width=65% fig-align='center' }
